...
\subsubsectionboxEDIT{The Inventory Accounting Flow/Cycle}{pratt2010financial}{
\begin{figure}[H]
	\centering
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[
		...
		\draw[-{Stealth[length=1mm]}, line width=0.25mm, Blue]
			...
			node[above] {First Sale} ([yshift=1.25mm]25.north east);
		\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
			([yshift=1.25mm]26.north west) -- node[above, pos=0.70] {Second Sale}
			([yshift=1.25mm]210.north east) |- ([yshift=1.25mm]33.north east);

		\node[txt, above=1.35cm of 12.south] () {\textbf{Beginning inventory}};
		\node[txt, above=1.35cm of 25.south] () {\textbf{First purchase}};
		\node[txt, above=1.35cm of 33.south] () {\textbf{Second purchase}};
		...
		\draw[-{Stealth[length=1mm]}, line width=0.25mm, Blue]
			([yshift=1.25mm]l210.north east) -- node[above] {First Sale} ([yshift=1.25mm]l23.north west);
		\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
			([yshift=1.25mm]l35.north east) -- node[above] {Second Sale} ([yshift=1.25mm]l31.north west);
		\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
			([yshift=1.25mm]l22.north east) -| node[above] {Second Sale} ([yshift=1.25mm]l13.north east) -- 
			([yshift=1.255mm]l13.north west);

		\node[txt, left=0.45cm of l11.north west, anchor=east] () {\textbf{LIFO:}};

		% ==============================================================================================
		\node[Rect1, below=0.95cm of l11.south, anchor=north] (a11) {4};
		\node[Rect1, right=of a11.east, anchor=west, fill=white] (a12) {4};
		\node[Rect1, right=of a12.east, anchor=west, fill=white] (a13) {4};

		\node[Rect2, right=1.5mm of a13.south east, anchor=south west, fill=white] (a21) {6};
		\node[Rect2, right=of a21.east, anchor=west, fill=white] (a22) {6};
		\node[Rect2, right=of a22.east, anchor=west, fill=white] (a23) {6};
		\node[Rect2, right=of a23.east, anchor=west, fill=white] (a24) {6};
		\node[Rect2, right=of a24.east, anchor=west, fill=white] (a25) {6};
		\node[Rect2, right=of a25.east, anchor=west, fill=white] (a26) {6};
		\node[Rect2, right=of a26.east, anchor=west, fill=white] (a27) {6};
		\node[Rect2, right=of a27.east, anchor=west, fill=white] (a28) {6};
		\node[Rect2, right=of a28.east, anchor=west, fill=white] (a29) {6};
		\node[Rect2, right=of a29.east, anchor=west, fill=white] (a210) {6};

		\node[Rect3, right=1.5mm of a210.south east, anchor=south west, fill=white] (a31) {8};
		\node[Rect3, right=of a31.east, anchor=west, fill=white] (a32) {8};
		\node[Rect3, right=of a32.east, anchor=west, fill=white] (a33) {8};
		\node[Rect3, right=of a33.east, anchor=west, fill=white] (a34) {8};
		\node[Rect3, right=of a34.east, anchor=west, fill=white] (a35) {8};

		\node[txt, left=0.45cm of a11.north west, anchor=east] () {\textbf{Average:}};
