...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance=0mm, auto, font=\tiny]
		\tikzstyle{Rect}=[draw, rectangle, minimum height=0.35cm, minimum width=0.8cm, fill=none,
			inner sep=0pt, line width=0.0005mm, xshift=-0.1mm];
		...
		\node[Rect, below=of seller.south, anchor=north, yshift=-10mm, xshift=0.1mm, fill=\scolor]
			(seller2) {Seller};
		...
		\draw[-, line width=0.05mm] (shipment.south) -- (shipment2.north);
		\path (shipment.south west) -- (shipment2.north west)
			node[draw=none, fill=gray!3, inner sep=0pt, minimum width=4cm, midway, align=left]
			(endofperiod) {
				End of the accounting period:\\
				FOB shipping: Both a sale and a purchase should be recorded\\
				FOB destination: Neither a sale nor a purchase should be recorded};
