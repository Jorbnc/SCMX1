...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance=1mm, auto, font=\tiny]
		...
		\node[Rect, minimum width=1.5cm, right=1.5cm of consignor.east, anchor=west] (consignee) {Consignee};
		\node[Rect, right=1.5cm of consignee.east, anchor=west] (customer) {Customer};
		\draw[-{Stealth[length=1mm]}] ([yshift=0mm]consignor.east) -- 
			node[pos=0.5, above, yshift=-0.2mm, align=left, font=\tiny] {Consignment} ([yshift=0mm]consignee.west);
		...
		\draw[-{Stealth[length=1.5mm]}, MoneyFlow, line width=0.5mm] ([xshift=0mm]customer.south) -- 
			++(0,-3mm) -| node[pos=0.25, above, yshift=-0.2mm, align=left, font=\tiny]
			{Revenue 100\%} ([xshift=6mm]consignee.south);
		\draw[-{Stealth[length=1.5mm]}, MoneyFlow, line width=0.1mm] ([xshift=+3mm]consignee.south) -- 
			++(0,-3mm) -| node[pos=0.25, above, yshift=-0.2mm, align=left, font=\tiny]
			{20\%}([xshift=-3mm]consignee.south);
		\draw[-{Stealth[length=1.5mm]}, MoneyFlow, line width=0.4mm] ([xshift=-6mm]consignee.south) -- 
			++(0,-3mm) -| node[pos=0.25, above, yshift=-0.2mm, align=left, font=\tiny]
			{80\%} (consignor.south);
	\end{tikzpicture}
\end{figure}
