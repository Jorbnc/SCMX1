...
\subsubsectionbox{COGS Allocation: FIFO, LIFO, Average Method}{pratt2010financial}{
	\begin{figure}[H]
		...
		\begin{tikzpicture}[
			...
			\node[txt, below=0.375cm of 12.south] () {Beginning inventory};
			\node[txt, below=0.375cm of 25.south east] () {First purchase};
			\node[txt, below=0.375cm of 33.south] () {Second purchase};
			...
			\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
				([yshift=1.25mm]l35.north east) -- node[above] {Second Sale LIFO} ([yshift=1.25mm]l31.north west);
			\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
				([yshift=1.25mm]l22.north east) -| node[above] {Second Sale LIFO} ([yshift=1.25mm]l13.north east) -- 
