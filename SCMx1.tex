...
\textbf{General Rule:} Items should be included if they're being held for sale and the company has complete and 
unrestricted ownership of them, such that potential losses and benefits are beared by the company.
Most of the time ownership means possesion, in such cases, the units to include can be simply counted. But there
are some scenarios in which this is not the case: Consignments and Goods in transit.
\breakspace
\textbf{Consignments:}
\breakspace
\textbf{Goods in Transit:}
\breakspace
\textbf{FOB:}
}
