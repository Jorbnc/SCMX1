...
\subsubsectionbox{Capitalization of Inventory Costs \& Units to include}{}{
...
\begin{itemize}
	...
	\item Storage 
	\item Packaging
	\item Distribution costs $\rightarrow$ Following the above logic, these would be considered as "selling expenses".
\end{itemize}
}

\subsubsectionbox{Accounting for Cash Discounts}{}{
Foo
}

\subsubsectionbox{Accounting for Manufacturing Costs}{}{
Foo
}
