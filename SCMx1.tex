...
\subsubsectionboxEDIT{LIFO Liquidation}{cfiLIFOliquidation, kinney2004jit}{
...
\subsubsectionbox{LIFO: Implications on Inventory Management}{kinney2004jit}{
\cite{kinney2004jit} observed several trends regarding the interaction between Just-In-Time inventory 
management, LIFO reserve dynamics, and financial decision-making in firms:
\breakspace
