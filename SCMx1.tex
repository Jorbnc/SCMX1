...
\begin{figure}[H]
	...
	\begin{tikzpicture}[node distance=0.4cm, auto, font=\tiny]
		...
		\node[Rect, minimum height=1.25cm, right=0.6cm of carrying.east, anchor=south west, yshift=0.1cm] (selling) {};
		\node[txt] () at (selling.north west)
			{\textbf{Selling Inventory}\\\vspace{-1mm}\\Cost Flow:\\\ding{223} FIFO\\\ding{223} LIFO\\\ding{223} Average};
		\node[Rect, minimum height=0.75cm, below=0.2cm of selling.south, anchor=north] (ending) {};
		\node[txt] () at (ending.north west)
			{\textbf{Ending Inventory}\\\vspace{-1mm}\\Foo};
...
\subsubsectionbox{Inventory record keeping: Periodic and Perpetual Systems}{pratt2010financial}{
...
\end{figure}%
\vspace{-1mm}
\Red{Maybe a stairs plot instead of many vertical lines}\\
...
\subsubsectionbox{COGS Allocation: FIFO, LIFO, Average Method}{pratt2010financial}{
	\begin{figure}[H]
		...
		\begin{tikzpicture}[
			...
			\node[Rect2, right=1.5mm of 13.east, anchor=west, fill=\acolor] (21) {};
			...
			\node[Rect3, right=1.5mm of 210.east, anchor=west, fill=\bcolor] (31) {};
			\node[Rect3, right=of 31.east, anchor=west, fill=\bcolor] (32) {};
			\node[Rect3, right=of 32.east, anchor=west, fill=\bcolor] (33) {};
			\node[Rect3, right=of 33.east, anchor=west] (34) {};
			\node[Rect3, right=of 34.east, anchor=west] (35) {};

			\draw[-{Stealth[length=1mm]}, line width=0.25mm, Blue]
				([yshift=1.25mm]11.north west) -- ([yshift=1.25mm]13.north east) |- 
				node[above] {First Sale FIFO} ([yshift=1.25mm]25.north east);
			\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
				([yshift=1.25mm]26.north west) -- ([yshift=1.25mm]210.north east) |- 
				node[above] {Second Sale FIFO} ([yshift=1.25mm]33.north east);

			\node[txt, below=0.65cm of 12.center] () {Beginning\\Inventory};
			\node[txt, below=0.65cm of 25.east] () {First\\Purchase};
			\node[txt, below=0.65cm of 33.center] () {Second\\Purchase};
			...
			\node[Rect2, right=1.5mm of l13.east, anchor=west, fill=\bcolor] (l21) {};
			...
			\node[Rect3, right=1.5mm of l210.east, anchor=west, fill=\bcolor] (l31) {};
			...
			\draw[-{Stealth[length=1mm]}, line width=0.25mm, Blue]
				([yshift=1.25mm]l210.north east) -- node[above] {First Sale LIFO} ([yshift=1.25mm]l23.north west);
			\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
				([yshift=-9.25mm]l35.north east) -- node[below] {Second Sale LIFO} ([yshift=-9.25mm]l31.north west);
			\draw[-{Stealth[length=1mm]}, line width=0.25mm, Red]
				([yshift=-1.25mm]l22.south east) -| node[below] {Second Sale LIFO} ([yshift=-1.25mm]l13.south east) -- 
				([yshift=-1.255mm]l13.south west);
...
\begin{figure}[H]
	...
	\end{tikzpicture}
\end{figure}%
The \textcolor{NavyBlue}{Perpetual LIFO COGS is \dollars 9300} and 
the \textcolor{BrickRed}{Periodic FIFO COGS is \dollars 9800}.
}
